        ...
        private void processVariableDeclaration(PsiVariable variable) {
            ...
            if (RULE_CONFIG.getClientsToCheck().contains(clientType.getPresentableText())) {
                ...
                if (!isAutoCompleteDisabled((PsiMethodCallExpression) initializer)) {
                    ...
                    holder.registerProblem(initializer, RULE_CONFIG.getAntiPatternMessageMap().get("antiPatternMessage"), CustomQuickFix.showRecommendationText(RULE_CONFIG.getRecommendationText(), RULE_CONFIG.getRecommendationLink()));
                }
            }
        }
