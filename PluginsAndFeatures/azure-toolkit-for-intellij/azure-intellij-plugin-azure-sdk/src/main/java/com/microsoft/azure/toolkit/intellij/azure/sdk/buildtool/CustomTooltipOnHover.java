...
class CustomTooltipOnHover implements LocalQuickFix {
    ...
    private void showDetailsTooltip(@NotNull PsiElement element, @NotNull Project project) {
        ...
        String htmlContent = "<html><body style='color: " + toHex(dynamicTextColor) + ";'><div class='tooltip'>" + recommendationText + " <a href='" + linkUrl + "' style='text-decoration: underline;'>Refer to Azure SDK for Java documentation</a>" + " for more information on this suggestion. </body></html>";
