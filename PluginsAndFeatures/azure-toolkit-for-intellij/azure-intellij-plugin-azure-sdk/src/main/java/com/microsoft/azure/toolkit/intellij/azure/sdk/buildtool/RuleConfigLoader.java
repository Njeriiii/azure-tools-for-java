...
public class RuleConfigLoader {
    ...
    private RuleConfig getRuleConfig(JsonReader reader) throws IOException {
        ...
        return new RuleConfig(methodsToCheck, clientsToCheck, servicesToCheck, discouragedIdentifiersToCheck, antiPatternMessage, recommendationText, recommendationLink);
    }
